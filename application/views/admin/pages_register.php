		...
		<div class="cls-content">
			<div class="cls-content-lg panel">
				<div class="panel-body">
					...
					<form action="<?=base_url('admin/registration');?>" method="POST" id="registration_page">
						<div class="row">
							<div class="col-sm-6">
				...
				<div class="pad-all">
					Already have an account ? <a href="<?=base_url('admin');?>" class="btn-link mar-rgt text-bold">Sign In</a>
