    ...
    <div class="boxed">
        ...
        <div id="content-container">
            <div id="page-head">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Slider Images List</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                <!--Breadcrumb-->
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Slider Images List</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading flex_justify_between">
                                <h4 class="panel-title">Slider Images List</h4>
                            ...
                            <div class="panel panel-body text-center">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr id="rowId_<?=$value['slider_id'];?>">
                                            <td><?=$i;?></td>
                                            <td><?php if($value['slider_image']){?>
                                                <img src="<?=base_url().slider_image_url.$value['slider_image'];?>" class="img-responsive">
                                                <?php } else { ?>
                                                <img src="https://via.placeholder.com/100C/O https://placeholder.com/" class="img-responsive">
                                                <?php }?>
                                            </td>
                                            <td><button class="btn btn-danger" onclick="delete_info('<?=$value['slider_id'];?>');"><i class="fa fa-close"></i> Delete</button></td>
                                        </tr>
                                        <?php $i++; }} else { ?>
                                        <tr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="slider_images[]" id="slider_images" class="form-control" id="fileupload" multiple>
                                </div>
                            </div>
                        </div>
...
<!-- FOOTER -->
    <script>
        var delete_info = function(slider_id) {
            var result = confirm("Want to delete?");
            if (result) {
                var url = '<?=base_url(); ?>admin/Home/delete_sliderInfo';
                $.ajax({
                    type: "POST",
                    url: url,
