                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel panel-body text-center" >
                                <table id="admin_example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Sr.no</th>
                                            <th>Image</th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?=base_url('admin/save_adminusers');?>" method="post" enctype="multipart/form-data" id="add_user_infos">
                        <div class="row">
                            <div class="col-md-6">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?=base_url('admin/update_adminusers');?>" method="post" id="update_user_infos" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fileupload">Image File</label>
...
<!-- FOOTER -->
    <script>
        var delete_info = function(user_id) {
            ...
            if (result) {
                var url = '<?=base_url(); ?>admin/Home/delete_adminuserInfo';
                $.ajax({
                    type: "POST",
                    url: url,
    ...
    <script>
        $('#import_form').on('submit', function(event){
			...
			$.ajax({
				url:"<?=base_url(); ?>admin/Import_ctrl/admin_import",
				method:"POST",
