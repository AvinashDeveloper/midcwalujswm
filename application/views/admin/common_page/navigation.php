                                ...
                                <div class="list-group bg-trans">
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/2.png" alt="Profile Picture">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/7.png" alt="Profile Picture">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/1.png" alt="Profile Picture">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/4.png" alt="Profile Picture">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/8.png" alt="Profile Picture">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="media-left pos-rel">
                                            <img class="img-circle img-xs" src="<?=base_url();?>assets/admin/img/profile-photos/9.png" alt="Profile Picture">
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        <div class="pad-btm">
                                            <img class="img-circle img-md" src="<?=base_url();?>assets/admin/img/profile-photos/1.png" alt="Profile Picture">
                                        </div>
                                        <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            <span class="pull-right dropdown-toggle">
                                                <!-- <i class="dropdown-caret"></i> -->
                                            </span>
                                            <p class="mnp-name"><?=$this->session->userdata('Login')[0]['user_firstname']; ?></p>
                                            <span class="mnp-desc"><?=$this->session->userdata('Login')[0]['user_email']; ?></span>
                                        </a>
                                    </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <?php if($this->session->userdata('Login')[0]['user_role'] == 'super_admin'){ ?>
                                    <li>
                                   ...
                                   <!-- <li>
                                        <a href="<?//=base_url('admin/vehical_info'); ?>">
                                            <i class="demo-pli-medal-2"></i>
                                            <span class="menu-title">
                                                Vehicle Entry
                                            </span>
                                    ...
                                    <li>
                                        <a href="<?=base_url('admin/waste_detail'); ?>">
                                            <i class="demo-pli-medal-2"></i>
                                            <span class="menu-title">
                                    ...
                                    <li>
                                        <a href="<?=base_url('admin/waste_schedule'); ?>">
                                            <i class="demo-pli-medal-2"></i>
                                            <span class="menu-title">
                                                Waste Schedule
                                            </span>
